...
from gamify.views import createTeam, joinChallenge, joinTeam, leaveTeam, login, getUserTasks, ChallengeInstanceViewSet, UserViewSet
...
urlpatterns = [
    ...
    path('models/users/tasks/', getUserTasks, name='get-user-tasks'),
