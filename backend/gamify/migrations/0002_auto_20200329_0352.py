# Generated by Django 3.0.4 on 2020-03-29 03:52
...
def load_challenges_and_tasks(apps, schema_editor):
    ...
    task_one.challenge = challenge_one
    task_two.challenge = challenge_one
    task_three.challenge = challenge_one
    task_four.challenge = challenge_one
    task_one.save()
    task_two.save()
    task_three.save()
    task_four.save()
